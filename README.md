...
There's isnt really any differences between a relational database and SQL. SQL is the query language used in relational databases.
...
Another table that references the both other tables with foreign key relationships.
